...
import { FaAd, FaGoogle } from 'react-icons/fa';

const Brands = () => {
    return (
        <section className="p-6 dark:bg-gray-800 dark:text-gray-100">
        <div className="container p-4 mx-auto text-center bg-primary">
            <h2 className="text-4xl font-bold">Brands We Sell</h2>
        </div>
        <div className="container flex flex-wrap justify-center mx-auto dark:text-gray-400">
            <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
                ...
                <FaGoogle className="fill-current w-14 h-14"></FaGoogle>
            </div>
            <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
                <svg xmlns="https://cdn-icons-png.flaticon.com/512/732/732148.png" viewBox="0 0 32 32" className="fill-current w-14 h-14">
            ...
            <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
            <img src="https://cdn-icons-png.flaticon.com/512/732/732148.png" alt="" className="fill-current w-14 h-14"/>
            </div>
            <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
            <img src="https://cdn-icons-png.flaticon.com/512/882/882849.png" alt="" className="fill-current w-20 h-20"/>
            </div>
            <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
            <img src="https://cdn.worldvectorlogo.com/logos/logo-lg.svg" alt="" className="fill-current w-24 h-24"/>
            </div>
            <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
            <img src="https://www.androidguys.com/wp-content/uploads/2020/07/OnePlus-Logo.png" alt="" className="fill-current w-24 h-24"/>
            </div>
            <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
            <img src="https://logos-world.net/wp-content/uploads/2020/11/BlackBerry-Logo.png" alt="" className="fill-current w-24 h-24"/>
            </div>
            <div className="flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4">
            <img src="https://vectorseek.com/wp-content/uploads/2021/01/Tecno-Logo-Vector-730x730.jpg" alt="" className="fill-current w-24 h-24"/>
            </div>
        </div>
    </section>
    );
